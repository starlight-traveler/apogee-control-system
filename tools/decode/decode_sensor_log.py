...
_LOG_SCHEMA_VERSION = 12
_TELEMETRY_STRUCT = struct.Struct("<65f16B")
...
_TELEMETRY_FLOAT_FIELD_NAMES = [
    ...
    "state_baro_vertical_velocity_fps",
    "state_baro_vertical_velocity_sigma_fps",
    "state_baro_vertical_velocity_residual_fps",
    "state_z_accel_sigma_scale",
    "sensor_accel_bno_x",
    "sensor_accel_bno_y",
    "sensor_accel_bno_z",
    "sensor_gyro_bno_x",
    ...
    "sensor_wt901_quat_y",
    "sensor_wt901_quat_z",
    "state_bno_quaternion_age_ms",
    "state_bno_reference_tilt_error_deg",
    "state_bno_reference_correction_applied",
]
...
_TELEMETRY_BOOL_FIELD_NAMES = [
    ...
    "state_baro_vertical_velocity_update_used",
    "state_baro_vertical_velocity_guard_active",
...
def _iter_records(stream: BinaryIO) -> Iterator[Tuple[str, dict]]:
    ...
    if len(preamble) == _LOG_PREAMBLE_STRUCT.size:
        ...
        if magic == _LOG_MAGIC:
            if _schema_version != _LOG_SCHEMA_VERSION:
                raise ValueError(
                    f"Unsupported log schema version {_schema_version}; "
                    f"this decoder supports schema {_LOG_SCHEMA_VERSION}."
                )
