...
The script reads [`docs/Doxyfile`](../../docs/Doxyfile) and writes generated HTML to `docs/api/`. That directory is ignored by git because it is a rebuildable artifact.
