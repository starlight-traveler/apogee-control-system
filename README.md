...
The generated API site lands at `docs/api/index.html`. The GitHub Pages workflow generates that directory before publishing `docs/`, so the public static docs include both the hand-written pages and the Doxygen source reference. Set the repository Pages source to GitHub Actions.
...
- [`docs/api/index.html`](docs/api/index.html): generated API docs after running Doxygen locally or in GitHub Pages
