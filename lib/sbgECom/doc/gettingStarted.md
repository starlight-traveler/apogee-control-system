...
This C code sample demonstrates the usage of the `sbgECom` library and the [sbgInsRestApi](https://developer.sbg-systems.com/sbgInsRestApi/) over a serial connection.
